...
C++ solutions and notes as I work through LeetCode problems. Each folder has the
problem's solution plus a short writeup on the approach and why it works.
...
Each `solution.cpp` is a standalone `Solution` class matching LeetCode's class-based
submission format, so it can be pasted directly into the LeetCode editor.
